<header id="topnav">
    <!-- Topbar Start -->
    <div class="navbar-custom" style="background-color: #206072">
                ...
                <li class="dropdown d-none d-lg-block">
                    <a class="nav-link dropdown-toggle mr-0" data-toggle="dropdown" href="#" role="button"
                       aria-haspopup="false" aria-expanded="false">
                        <img src="/assets\images\flags\vn.jpg" alt="user-image" class="mr-2" height="12"> <span
                            class="align-middle"> Viet Nam <i class="mdi mdi-chevron-down"></i> </span>
                    </a>
...
<%--                    <a class="nav-link dropdown-toggle  waves-effect waves-light" data-toggle="dropdown" href="#"--%>
<%--                       role="button" aria-haspopup="false" aria-expanded="false">--%>
<%--                        <img src="/assets\images\flags\us.jpg" alt="user-image" class="mr-2" height="12">--%>
...
<%--                    </a>--%>
                            ...
                            <div class="inbox-widget">
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="/assets\images\img\avatar.jpg"
                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown"
                       href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <img src="/assets\images\users\avatar100.jpg" alt="user-image" class="rounded-circle">
                    </a>
            ...
            <div class="logo-box">
                <a href="/products" class="logo text-center">
                                    <span class="logo-lg">
                                        <img src="/assets\images\img\logo-xe-may.jpg" alt="" height="60" width="100">
