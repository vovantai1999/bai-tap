...
public class ProductCreateDTO implements Validator{
    ...
    @Min(value = 1000000, message = "Số tiền nhỏ nhất là 1.000.000VND")
    @Max(value = 2000000000, message = "Số tiền tối đa là 2.000.000.000VND")
    ...
    public void validate(Object target, Errors errors) {
        ...
        } else if (Long.valueOf(price) < 1000000) {
            errors.rejectValue("price", "","Giá sản phẩm thấp nhất là 1.000.000 vnđ");
